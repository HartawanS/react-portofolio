            ...
            <div className="hero">
                <div className="card form-box">
                    <div className="button-box row">
                        ...
                        <button className={'toggle-btn ' + (this.state.signin? 'btn-active': '')} onClick={this.changeStatus(true)}>Log In</button>
                        <button className={'toggle-btn ' + (!this.state.signin? 'btn-active': '')} onClick={this.changeStatus(false)}>Register</button>
                    </div>
