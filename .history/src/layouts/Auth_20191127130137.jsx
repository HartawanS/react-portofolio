            ...
            <div className="hero">
                <div className="card form-box">
                    <div className="button-box row">
                        ...
                        <button type="button" className={'toggle-btn ' + this.state.signin? 'ini': ''} onClick={this.changeStatus(true)}>Log In</button>
                        <button type="button" className={'toggle-btn ' + !this.state.signin? 'ini': ''} onClick={this.changeStatus(false)}>Register</button>
                    </div>
